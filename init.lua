--[[
extensions to eventually setup
nx.nvim
packer
nerd-font
nvim-tree
...
vim.cmd [[ command! Gmt execute 'lua vim.lsp.buf.formatting_sync()']]
vim.keymap.set('n', '<Leader>f', 'Fmt<cr>')
...
--vim.keymap.set('n', '<leader>fb', ":Format<cr>")
